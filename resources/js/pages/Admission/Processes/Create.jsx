...
export default function AdmissionProcessesCreate({ periods, careers, defaultCareer }) {
        ...
        <div className="page-enter">
            <div className="max-w-7xl mx-auto px-5 sm:px-8">
                <div className="mb-6">
                    ...
                    <h2 className="text-3xl font-bold text-navy mt-2">Nueva Convocatoria de Admisión</h2>
                    <p className="text-slate-500">Crea una nueva convocatoria con vacantes y periodo académico.</p>
                </div>
                        ...
                        <div className="p-6">
                            <form onSubmit={submit}>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    <div className="col-span-2">
                                        ...
                                        <input
                                            ...
                                            required
                                            placeholder="Ej. Admisión Ordinaria 2026-II"
                                ...
                                <div className="flex justify-end">
                                    ...
                                    >
                                        {processing ? 'Creando...' : 'Crear Convocatoria'}
                                    </button>
                                </div>
                            </form>
                        </div>
...
AdmissionProcessesCreate.layout = (page) => <AppLayout>{page}</AppLayout>
