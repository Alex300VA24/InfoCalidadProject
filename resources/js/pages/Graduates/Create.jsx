...
export default function GraduatesCreate({ students, workStatuses }) {
            ...
            <div className="max-w-4xl mx-auto px-5 sm:px-8">
                <div className="flex justify-between items-end mb-6">
                    <div>
                        ...
                        <h2 className="text-3xl font-bold text-navy mt-2">Registrar Egresado</h2>
                        <p className="text-slate-500">Registra la información de inserción laboral de un egresado.</p>
                    </div>
                </div>
                    ...
                    <div className="p-6">
                        <form onSubmit={submit}>
                            ...
                            <div className="flex justify-end">
                                <a href="/graduates" className="px-4 py-2 border border-slate-300 text-slate-600 rounded-lg text-sm font-bold mr-2 hover:bg-slate-50 transition-colors">Cancelar</a>
                                <button type="submit" disabled={processing} className="px-4 py-2 bg-navy text-white rounded-lg text-sm font-semibold hover:bg-[#343d96] transition-colors">
                                    {processing ? 'Registrando...' : 'Registrar Egresado'}
                                </button>
                            </div>
                        </form>
                    </div>
...
GraduatesCreate.layout = (page) => <AppLayout>{page}</AppLayout>
