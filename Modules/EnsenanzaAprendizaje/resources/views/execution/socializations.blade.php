    ...
    <x-slot name="header">
        <div class="flex justify-between items-end">
            ...
            <div class="flex gap-3">
                <a href="{{ route('execution.socializations.create') }}" class="px-4 py-2 bg-accent text-ink font-black rounded shadow-md text-sm hover:brightness-95 transition-all">+ Registrar Socialización</a>
            </div>
        </div>
    </x-slot>
