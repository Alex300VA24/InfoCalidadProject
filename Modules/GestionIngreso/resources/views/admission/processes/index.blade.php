    ...
    <x-slot name="header">
        <div class="flex flex-wrap justify-between items-end gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('admission.processes.create') }}" class="inline-flex items-center gap-1.5 px-4 py-2 bg-accent text-ink font-black rounded shadow-md text-sm hover:brightness-95 transition-all">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-3 py-1 rounded-full text-xs font-bold border
                                            {{ $process->status === 'abierto' ? 'text-emerald-700 bg-emerald-100 border-emerald-200' : ($process->status === 'cerrado' ? 'text-slate-600 bg-slate-100 border-slate-200' : 'text-amber-700 bg-amber-100 border-amber-200') }}">
                                            {{ $process->statusLabel() }}
                                        </span>
                                    </td>
